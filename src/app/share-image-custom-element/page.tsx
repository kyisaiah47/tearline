...
const ROUTES: [string, string, string][] = [
  [
    ...
    "The element renders the thing AND exports it. Right when the user is looking at the artefact and wants a PNG of it on click. Tearline is 22,769 bytes served, HTTP 200 on 8 September 2026.",
  ],
  [
    "modern-screenshot",
...
export default function ShareImageCustomElement() {
  return (
    <>
      ...
      <SiteShell eyebrow={"Decision"} title={"Four ways to make a share image."}>
                ...
                <div className={"tl-docs"}>
                  <div className={"tl-docs-col"}>
                    ...
                    <p className={"tl-docs-note"}>
                      ...
                      <code>{"<tear-line>"}</code>
                      {
                        " and it renders as a thermal receipt, paper texture, dashed rules, seeded torn edge, barcode, and the element exports that. One script tag, no build step, no runtime dependencies, 22,769 bytes served unminified at "
                      }
